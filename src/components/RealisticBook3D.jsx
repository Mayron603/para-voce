...
const pagesData = [
  ...
  {
    front: {
      text: "E sobre o nosso futuro… não tenho muito o que dizer, só que vou fazer de tudo pra dar certo. Disso você pode ter certeza. Inclusive nos seus estudos, nos seus sonhos, em tudo que você quiser construir. \n\n E nesse Natal, eu só quero que você se sinta bem. \n Que seu coração fique tranquilo, e que você consiga aproveitar bastante assistindo seu Grinch. \n E que você nunca duvide do quanto é especial."
    },
    back: {
